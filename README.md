...
[المميزات](#-المميزات-الرئيسية) • [الجديد](#-ما-الجديد-في-الإصدار-30) • [التشغيل](#-طريقة-التشغيل) • [التثبيت](#-التثبيت-في-قائمة-البرامج) • [البناء](#-البناء-من-المصدر)
...
### 🎵 نظام قراء متعدد
- **5 قراء معتمدين** للاختيار منهم:
  - 🎙️ مشاري العفاسي (مجود)
  - 🎙️ محمود خليل الحصري (حدر) 
  - 🎙️ محمد صديق المنشاوي (ترتيل)
  - 🎙️ أبو بكر الشاطري (مجود)
  - 🎙️ سعد الغامدي (حدر)
